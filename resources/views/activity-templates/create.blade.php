...
<head>
    ...
    <title>Tambah Template Kegiatan</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-100 min-h-screen">
    <div class="max-w-3xl mx-auto py-8 px-4">
        <h1 class="text-2xl font-bold mb-6">Tambah Template Kegiatan</h1>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form action="{{ route('activity-templates.store') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                        placeholder="Contoh:
PETUGAS WELCOME SNACK {tanggal}
{daftar_pegawai}"
                    >{{ old('whatsapp_message') }}</textarea>
                    <p class="text-sm text-gray-500 mt-1">
                        Anda bisa menyiapkan template pesan yang nanti dipakai saat event dibuat.
                    </p>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox"
                           ...
                           value="1"
                           {{ old('needs_employee_list') ? 'checked' : '' }}>
